  ...
  */
  ...
  render() {
    ...
    return (<figure className={igmFigureClassName}
      style={styleObj} ref="figure" onClick={this.handleClick.bind(this)}>
      <p className='photo'>
  ...
  */
  ...
  render() {
    ...
    imageDatas.forEach(function (value, index) {
        ...
        imgFigures.push(<ImgFigure data={value} ref={'imgFigure' + index} key={index} arrange={this.state.imgArrangeArr[index]} inverse={this.inverse(index).bind(this)} center={this.center(index).bind(this)}
          />);
